...
angular.module('stoxumcharts.topology', [
  'ui.state',
  'ui.bootstrap'
])
  ...
  .config(function config($stateProvider) {
    $stateProvider.state('topology', {
      ...
      data: {
        pageTitle: 'Stoxumd Topology Network'
      }
    })
  })
  ...
  .controller('TopologyCtrl', function TopologyCtrl($scope, $http) {
    ...
    function updateVersionGraph(nodes) {
      ...
      nodes.forEach(function (d) {
        version = d.version.replace('stoxumd-', '')
    ...
    $http
      .get(API + '/network/stoxumd_versions')
      .then(function (d) {
