var OrderBook = function (options) {
  ...
  this.getMarket = function (base, trade) {
    ...
    function addListeners() {
      ...
      asks = stoxumOrderbook.OrderBook.createOrderBook(r, {
      ...
      bids = stoxumOrderbook.OrderBook.createOrderBook(r, {
  ...
  //handle data returned from stoxum-lib
  ...
  //draw the chart data loaded from stoxum-lib
