angular.module('stoxumName', [])
  .factory('stoxumName', function ($http) {

    var names = {};
    var reversed = {};
    var URL = 'https://id.stoxum.com/.well-known/webfinger?resource=';
    var addressRel = 'https://stoxum.com/rel/stoxum-address';
    var nameRel = 'https://stoxum.com/rel/stoxum-name';
    ...
    var lookup = function (text, callback) {
      ...
      // by address NOTE: should validate stoxum address
