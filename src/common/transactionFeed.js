angular.module('txfeed', [])
  .directive('txfeed', ['$timeout', '$sce', '$compile', function ($timeout, $sce, $compile) {
    ...
    var currencyOrder = ['XAU', 'XAG', 'BTC', 'LTC', 'STM', 'EUR', 'USD', 'GBP', 'AUD', 'NZD', 'USD', 'CAD', 'CHF', 'JPY', 'CNY'];
    ...
    return {
      ...
      link: function (scope, element, attr) {
        ...
        function handleTransaction(tx) {
          ...
          if (type === 'OfferCreate') {
            var c1 = tx.transaction.TakerPays.currency || 'STM';
            var c2 = tx.transaction.TakerGets.currency || 'STM';
            var direction = 'buy';
